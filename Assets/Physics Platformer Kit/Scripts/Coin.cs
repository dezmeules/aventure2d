...
public class Coin : MonoBehaviour 
{
	...
	void Awake()
	{
		...
		RubberDucky = transform.Find("RubberDucky").gameObject;

		RubberDucky.transform.Rotate (new Vector3(0,1,0) * Random.Range(0,360), Space.World);
	...
	void Update()
	{
		RubberDucky.transform.Rotate (rotation * Time.deltaTime, Space.World);
